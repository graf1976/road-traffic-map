...
export function RoadHint({ name, operator }: RoadHintProps) {
  return (
    <div className="pointer-events-none absolute left-1/2 top-3 z-10 flex max-w-[calc(100%-10rem)] -translate-x-1/2 items-center gap-2 rounded-full bg-white/95 py-1.5 pl-3 pr-2 shadow-md ring-1 ring-slate-200">
